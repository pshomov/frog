...
namespace Frog.FunctionalTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("In order to have Runz continously integrate my project\nAs anyone on the Internet\nI want to be able to register the project")]
